...
{
    // default connection
    public static $dbname = 'efbcfd8_db'; // Your database name
    public static $dbuser = 'efbcfd8_dbuser'; // Your database username
    public static $dbpass = 'efbcfd8_dbuser'; // // Your database password
